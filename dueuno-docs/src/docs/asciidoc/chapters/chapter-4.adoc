...
.Edit `~/demo/grails-app/conf/logback-spring.xml` and copy the following:
...
<configuration>
    ...
    <appender name="FILE" class="ch.qos.logback.core.rolling.RollingFileAppender">
        ...
        <rollingPolicy class="ch.qos.logback.core.rolling.SizeAndTimeBasedRollingPolicy">
            <fileNamePattern>${appName}/logs/archive/${appName}.%d{yyyy-MM-dd}.%i.log.zip</fileNamePattern>
