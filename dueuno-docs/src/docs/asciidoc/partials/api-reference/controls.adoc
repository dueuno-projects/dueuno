...
|Message displayed in the upload area.
|`textDisabled`
|`String`
|`control.upload.disabled`
|Message displayed when the upload control is disabled.
|`acceptedFiles`
|`List`
|`[]`
|List of accepted file extensions or MIME types.
|`maxFiles`
|`Integer`
|
...
|`Boolean`
|`false`
|If set to `true`, file previews are disabled.
|===
